...
import { ListaPage } from '../pages/modulo-vendas/pesquisas/subpesquisas/lista/lista'
import { PesquisaPage } from '../pages/modulo-vendas/pesquisas/subpesquisas/lista/pesquisa/pesquisa'
@NgModule({ 
  declarations: [
    MyApp, 
    PrincipalPage,
